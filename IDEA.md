...
- the SVG arena supports multi-unit placement, activation, movement, shooting, pivot, about-face, skip, move into combat, combat resolution, morale, pending pushback/withdraw choices, win completion, action history, rewind, URL-addressable game steps, and zoom/pan camera controls.
- wheel movement, special ability execution beyond shooting-related hooks, sockets, and multiplayer auth are still deferred.
